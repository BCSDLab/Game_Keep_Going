...
public class LoadJsonData : MonoBehaviour
{
    ...
    public bool loadInStore = false;
    public bool loadInStage = false;
    ...
    private void ChangeTrain()
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            if (Train.transform.GetChild(i).childCount != 1)
            {
                Destroy(Train.transform.GetChild(i).GetChild(1).gameObject);
            }
        }
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            else
            {
                ...
                module.transform.parent = GameObject.Find("Train").transform.GetChild(i);
